            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block">
                        <img src="admin/img/undraw_rocket.svg" alt="">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="xulydangky.php" name="frmdk" method="post">
                            ...
                            <div class="text-center">
                                <a class="small" href="dangnhap.php">Tôi đã có tài khoản</a>
                            </div>
                        </div>
                    </div>
                </div>
